...
function AddLandlord() {
  ...
  let initiallandlord={landlordId:'',landlordName:'',landlordAge:''};
  ...
  return (
    ...
    onChange={e=>setLandlord({...landlord,landlordName:e.target.value})}/>
    <input name="landlordeage" type="number" placeholder="Landlord Age" class="col-md-4 address-tags"
    onChange={e=>setLandlord({...landlord,landlordAge:e.target.value})}/>
    <br/><br/><br/><br/>
